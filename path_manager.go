...
type pathManager struct {
	...
	cubicSenders map[protocol.PathID]*congestion.CubicSender
...
func (pm *pathManager) setup(conn connection) {
	...
	pm.cubicSenders = make(map[protocol.PathID]*congestion.CubicSender)
	...
	pm.sess.paths[protocol.InitialPathID].setup(pm.cubicSenders)
